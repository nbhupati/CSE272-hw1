        ...
        try (IndexWriter w = new IndexWriter(index, config)) {
            try {
                ...
                while (myReader.hasNextLine()) {
                    ...
                    //titlefound = data.equals(".T");
                    //descriptionfound = data.equals(".W");

                    if (idfound) {
                        //array that has doc id, title, and description
                        infofound[0] = data;
                        idfound = false;
                        //System.out.println("has doc id");
                    }
                    if (titlefound) {
                        infofound[1] = data;
                        titlefound = false;
...
//            addDoc(w, "The Art of Computer Science", "9900333X");
        // writing into memory index
        //only one addDoc
        // iterate through array list
        // name of array list.get value at that index
        //w.close();
        //}
        return index;
    }
...
//                titleFound = data.contains("<title>");
                if (descrptionFound) {
                    top[2] = data;
...
//                        System.out.println("ann end");
//                        System.out.println("after desc");
                    int hitsPerPage = 50;


//                        System.out.println("after index");
                    //indexing part is where you store the index file
                    //return that parameter for the indexing
...
//                            Document d = searcher.getIndexReader().document(docId);
//                            System.out.println((i + 1) + ". " + d.get("title") + "\t" + d.get("docID"));
//                        }
                        }
...
//        });
                        //override to implement Tf, TF-IDF, etc.
                        // get the results from this

                        // override using this searcher.setSimilarity();
                        // helps with the 4 different algorithms
